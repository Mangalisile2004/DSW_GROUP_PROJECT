    ...
    grid.innerHTML = services.map(service => `
        <div class="service-card" onclick='showServiceDetail(${JSON.stringify(service)})'>
            <div class="service-image">
                ...
                <span class="service-category-badge">${escapeHtml(service.servicetype || 'General')}</span>
            </div>
            <div class="service-info">
                <h3 class="service-name">${escapeHtml(service.fullname)} ${escapeHtml(service.surname)}</h3>
                ...
                <div class="service-location">
                    ...
                    <span>${escapeHtml(service.campus || 'Any campus')}</span>
                </div>
